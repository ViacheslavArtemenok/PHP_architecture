<header>
    <div class="header_up">
        <div class="wrap_head">
            <div class="logo_left">
                <a class="logo_left_img logo_main" href="index.php"><svg width="44" height="38" viewBox="0 0 44 38" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                <details class="details_search">
                    ...
                    <form class="area_search" action="index.php?c=search" method="POST" enctype="multipart/form-data">
                        <input name="search_data" class="input_search" required type="text" placeholder="Enter Your Keyword">
                        <button class="btn_search" type="submit">Search</button>
                    </form>
                </details>
            </div>
            <div class="logo_right">
                <details id="header_menu" class="logo_right_img menu">
                    <summary>
                        <svg width="32" height="23" viewBox="0 0 32 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path class="logo_svg" d="M0 23V20.31H32V23H0ZM0 12.76V10.07H32V12.76H0ZM0 2.69V0H32V2.69H0Z" fill="#E8E8E8" />
                        </svg>
                    </summary>
                    <div class="list_box">
                        <div class="close" onClick="close_menu()"><svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a class="pink_list" href="index.php?c=catalog&type=1">men</a>
                        <ul>
                            <li><a class="menu_list" href="index.php?c=catalog&type=1">Jackets & Coats</a></li>
                            <li><a class="menu_list" href="index.php?c=catalog&type=1">Polos</a></li>
                            <li><a class="menu_list" href="index.php?c=catalog&type=1">T-Shirts</a></li>
                            <li><a class="menu_list" href="index.php?c=catalog&type=1">Shirts</a></li>
                        </ul>
                        <a class="pink_list" href="index.php?c=catalog&type=2">women</a>
                        <ul>
                            <li><a class="menu_list" href="index.php?c=catalog&type=2">Jackets & Coats</a></li>
                            <li><a class="menu_list" href="index.php?c=catalog&type=2">Polos</a></li>
                            <li><a class="menu_list" href="index.php?c=catalog&type=2">T-Shirts</a></li>
                            <li><a class="menu_list" href="index.php?c=catalog&type=2">Shirts</a></li>
                        </ul>
                        <a class="pink_list" href="index.php?c=catalog&type=3">kids</a>
                        <ul>
                            <li><a class="menu_list" href="index.php?c=catalog&type=3">Jackets & Coats</a></li>
                            <li><a class="menu_list" href="index.php?c=catalog&type=3">Polos</a></li>
                            <li><a class="menu_list" href="index.php?c=catalog&type=3">T-Shirts</a></li>
                            <li><a class="menu_list" href="index.php?c=catalog&type=3">Shirts</a></li>
                        </ul>
                        <a class="pink_list hide_tittle" href="index.php?c=user&action=<?= $reg_way ?>"><?= $reg_way_text ?></a>
                        <a class="pink_list hide_tittle" href="index.php?c=reviews">reviews</a>
                        <a class="pink_list hide_tittle" href="<?= $config_data_user ? 'index.php?c=cart&state=show' : 'index.php?c=user&action=1' ?>">cart</a>
                    </div>
                </details>
                <a class="logo_right_img" href="index.php?c=<?= urlencode('user') ?>&action=<?= $reg_way ?>"><svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a class="logo_right_img" href="index.php?c=reviews"><svg width="29" height="29" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <path class="logo_svg" d="M14 3v2H4v13.385L5.763 17H20v-7h2v8a1 1 0 0 1-1 1H6.455L2 22.5V4a1 1 0 0 1 1-1h11zm5 0V0h2v3h3v2h-3v3h-2V5h-3V3h3z" fill="#E8E8E8" />

                    </svg>
                </a>
                <a class="logo_right_img add_pos" href="<?= $config_data_user ? 'index.php?c=cart&state=show' : 'index.php?c=user&action=1' ?>"><svg width="32" height="29" viewBox="0 0 32 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="cart_include_amount">
                        <div id="cart_include_index" class="cart_include_amount_p"></div>
                    </div>
                </a>
            </div>
        </div>
