<div class="back">
    <div class="back_box">
        <div class="wrap_promo">
            <img class="img_promo" src="img/img_other/man.png" alt="promo">
...
<div class="wrap">
    <div class="block_items">
        <a class="item_box" href="index.php?c=catalog&type=2">
            <img class="img_item" src="img/img_other/w.jpg" alt="w">
            <div class="item_text">
                <h3 class="item_h3">30% OFF</h3>
                <h1 class="item_h1">FOR WOMEN</h1>
            </div>
        </a>
        <a class="item_box" href="index.php?c=catalog&type=1">
            <img class="img_item" src="img/img_other/m.jpg" alt="m">
            <div class="item_text">
                <h3 class="item_h3">HOT DEAL</h3>
                <h1 class="item_h1">FOR MEN</h1>
            </div>
        </a>
        <a class="item_box" href="index.php?c=catalog&type=3">
            <img class="img_item" src="img/img_other/k.jpg" alt="k">
            <div class="item_text">
