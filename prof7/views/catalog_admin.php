    ...
    <div class="main_tittle_box">
        <div class="main_tittle">
            ...
            <div class="way">
                ...
                <a class="way_text" href="index.php?c=admin_catalog&type=<?= $config_type ?>"><?= $config_some_gender ?>&nbsp;</a>
                <a class="way_text" href="index.php?c=admin_catalog&type=<?= $config_type ?>">NEW ARRIVALS</a>
            </div>
        </div>
    </div>
...
<div id="box_for_goods_admin" class="wrap_product">
    <?php
...
<form id="more_goods_admin" class='box_btn'>
    <input type="text" id="more_goods_input_admin" name="more_goods" value="9" hidden>
    <input type="text" name="type" value="<?= $config_type ?>" hidden>
    <input type="submit" id="more_goods_submit_admin" hidden>
    <label for="more_goods_submit_admin" class='btn'>More goods</label>
</form>
