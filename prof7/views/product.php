        ...
        <div class="main_tittle_box">
            <div class="main_tittle">
                ...
                <div class="way">
                    ...
                    <a class="way_text" href="index.php?c=catalog&type=<?= $_POST['number_g'] ?>"><?= $_POST['gender'] ?>&nbsp;</a>
                    <a class="way_text" href="index.php?c=catalog&type=<?= $_POST['number_g'] ?>">NEW ARRIVALS</a>
                </div>
            </div>
        </div>
        <div class="prd_back">
            <div class="prd_wrap" style="background-image: url(img/product/<?= $_POST['gender'] ?>/<?= $_POST['photo_name'] ?>)">
            </div>
        </div>
    </nav>
    ...
    <div class="box_collection">
        ...
        <div class="collection_add_box" onclick="addToCart(`<?= $_POST['number_g'] ?>`, `<?= $_POST['id'] ?>`, `<?= $_POST['name'] ?>`, ``, `<?= $_POST['price'] ?>`, `<?= $_POST['photo_name'] ?>`, 1, `<?= $_POST['gender'] ?>`)">
