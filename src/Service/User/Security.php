<?php
//!!!!!!!!Registry!!!!!!!!Здесь данный паттерн нужен для доступа к данным объекта класса Сессии без возможности его изменить
//Записываем данные юзера по ключу SESSION_USER_IDENTITY  $this->session->set(self::SESSION_USER_IDENTITY, $user->getId());
//получаем  $userId = $this->session->get(self::SESSION_USER_IDENTITY);
